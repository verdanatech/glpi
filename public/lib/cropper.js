...
/* harmony export */ });
/* harmony import */ var _cropper_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1306);
/* harmony import */ var _cropper_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1304);
...
class CropperCanvas extends _cropper_element__WEBPACK_IMPORTED_MODULE_0__["default"] {
    ...
    $handlePointerDown(event) {
        ...
        const { $pointers } = this;
        let action = _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.ACTION_NONE;
        if ($pointers.size > 1) {
            ...
            action = event.target.action
                || event.target.getAttribute(_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.ATTRIBUTE_ACTION)
                || _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.ACTION_NONE;
        }
    ...
    $handlePointerUp(event) {
        ...
        if ($action === _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.ACTION_NONE) {
            this.$removePointers(event);
            return;
        }
...
class CropperImage extends _cropper_element__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor() {
        ...
        this.initialFit = _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_CONTAIN;
        this.maxFit = '';
        this.minFit = '';
    ...
    $center(size) {
        ...
        if (size || maxFit || minFit) {
            ...
            switch (size) {
                case _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_COVER:
                    if ([
                        _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_FILL,
                        _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_CONTAIN,
                        _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_SCALE_DOWN,
                    ].includes(maxFit) || (maxFit === _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_NONE
                        && (naturalWidth < containerWidth || naturalHeight < containerHeight))) {
                        size = maxFit;
                    }
                    else if (minFit === _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_NONE
                        && naturalWidth > containerWidth
                        && naturalHeight > containerHeight) {
                        size = minFit;
                    }
                    break;
                case _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_FILL:
                    if ([_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_CONTAIN, _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_SCALE_DOWN].includes(maxFit) || (maxFit === _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_NONE
                        && (naturalWidth < containerWidth || naturalHeight < containerHeight))) {
                        size = maxFit;
                    }
                    else if (minFit === _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_COVER || (minFit === _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_NONE
                        && naturalWidth > containerWidth
                        && naturalHeight > containerHeight)) {
                        size = minFit;
                    }
                    break;
                case _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_CONTAIN:
                    if (maxFit === _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_SCALE_DOWN || (maxFit === _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_NONE
                        && naturalWidth < containerWidth
                        && naturalHeight < containerHeight)) {
                        size = maxFit;
                    }
                    else if ([_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_COVER, _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_FILL].includes(minFit) || (minFit === _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_NONE
                        && (naturalWidth > containerWidth || naturalHeight > containerHeight))) {
                        size = minFit;
                    }
                    break;
                case _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_SCALE_DOWN:
                    if (maxFit === _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_NONE
                        && naturalWidth < containerWidth
                        && naturalHeight < containerHeight) {
                        size = maxFit;
                    }
                    else if ([_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_COVER, _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_FILL, _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_CONTAIN].includes(minFit) || (minFit === _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_NONE
                        && (naturalWidth > containerWidth && naturalHeight > containerHeight))) {
                        size = minFit;
                    }
                    break;
                ...
                default:
                    if ([
                        _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_COVER,
                        _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_FILL,
                        _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_CONTAIN,
                        _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_SCALE_DOWN,
                    ].includes(maxFit)
            ...
            switch (size) {
                ...
                case _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_SCALE_DOWN:
                    ...
                    break;
                case _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_NONE:
                    this.$scale(1);
                    break;
            }
        }
            ...
            if ((0,_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.isNumber)(a)
                ...
                if (this.$isReady && this.$canvas) {
                    ...
                    if (maxFit || minFit) {
                        ...
                        const { naturalWidth, naturalHeight } = this.$image;
                        if (maxFit === _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_SCALE_DOWN) {
                            if (naturalWidth >= canvasRect.width || naturalHeight >= canvasRect.height) {
                                maxFit = _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_CONTAIN;
                            }
                            else {
                                maxFit = _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_NONE;
                            }
                        }
                        switch (maxFit) {
                            case _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_COVER:
                        ...
                        if (minFit === _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_SCALE_DOWN) {
                            if (naturalWidth >= canvasRect.width || naturalHeight >= canvasRect.height) {
                                minFit = _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_CONTAIN;
                            }
                            else {
                                minFit = _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_NONE;
                            }
                        }
                        switch (minFit) {
                            case _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.OBJECT_FIT_COVER:
...
class CropperShade extends _cropper_element__WEBPACK_IMPORTED_MODULE_0__["default"] {
        ...
        if ($canvas) {
            ...
            if ($selection) {
                ...
                this.$onSelectionChange = (event) => {
                    var _a, _b;
                    if (((_b = (_a = event.target) === null || _a === void 0 ? void 0 : _a.constructor) === null || _b === void 0 ? void 0 : _b.$name) !== _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.CROPPER_SELECTION) {
                        return;
                    }
                ...
                (0,_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.on)(window, _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.EVENT_RESIZE, this.$onWindowResize);
                (0,_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.on)($canvas, _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.EVENT_ACTION_START, this.$onCanvasActionStart);
                (0,_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.on)($canvas, _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.EVENT_ACTION_END, this.$onCanvasActionEnd);
    ...
    disconnectedCallback() {
        ...
        if ($canvas) {
            if (this.$onWindowResize) {
                (0,_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.off)(window, _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.EVENT_RESIZE, this.$onWindowResize);
                this.$onWindowResize = null;
            }
            if (this.$onCanvasActionStart) {
                (0,_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.off)($canvas, _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.EVENT_ACTION_START, this.$onCanvasActionStart);
    ...
    $render() {
        return this.$setStyles({
            ...
            width: this.width,
            height: this.height,
            outlineWidth: _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.WINDOW.innerWidth * _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.WINDOW.devicePixelRatio,
        });
    }
}
...
/* harmony export */ });
/* harmony import */ var _cropper_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1304);
...
const supportsAdoptedStyleSheets = Boolean(_cropper_utils__WEBPACK_IMPORTED_MODULE_0__.WINDOW.document
    && Array.isArray(_cropper_utils__WEBPACK_IMPORTED_MODULE_0__.WINDOW.document.adoptedStyleSheets)
    && _cropper_utils__WEBPACK_IMPORTED_MODULE_0__.WINDOW.CSSStyleSheet
    && "replaceSync" in _cropper_utils__WEBPACK_IMPORTED_MODULE_0__.WINDOW.CSSStyleSheet.prototype);
...
/* harmony export */ });
/* harmony import */ var _cropper_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1306);
/* harmony import */ var _cropper_element_canvas__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1307);
/* harmony import */ var _cropper_element_image__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1308);
/* harmony import */ var _cropper_element_shade__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1309);
/* harmony import */ var _cropper_element_handle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1310);
/* harmony import */ var _cropper_element_selection__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1311);
/* harmony import */ var _cropper_element_grid__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1312);
/* harmony import */ var _cropper_element_crosshair__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(1313);
/* harmony import */ var _cropper_element_viewer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(1314);
...
/* harmony export */   OBJECT_FIT_CONTAIN: () => (/* binding */ OBJECT_FIT_CONTAIN),
/* harmony export */   OBJECT_FIT_COVER: () => (/* binding */ OBJECT_FIT_COVER),
/* harmony export */   OBJECT_FIT_FILL: () => (/* binding */ OBJECT_FIT_FILL),
/* harmony export */   OBJECT_FIT_NONE: () => (/* binding */ OBJECT_FIT_NONE),
/* harmony export */   OBJECT_FIT_SCALE_DOWN: () => (/* binding */ OBJECT_FIT_SCALE_DOWN),
...
/* harmony export */   OBJECT_FIT_CONTAIN: () => (/* reexport safe */ _cropper_utils__WEBPACK_IMPORTED_MODULE_0__.OBJECT_FIT_CONTAIN),
/* harmony export */   OBJECT_FIT_COVER: () => (/* reexport safe */ _cropper_utils__WEBPACK_IMPORTED_MODULE_0__.OBJECT_FIT_COVER),
/* harmony export */   OBJECT_FIT_FILL: () => (/* reexport safe */ _cropper_utils__WEBPACK_IMPORTED_MODULE_0__.OBJECT_FIT_FILL),
/* harmony export */   OBJECT_FIT_NONE: () => (/* reexport safe */ _cropper_utils__WEBPACK_IMPORTED_MODULE_0__.OBJECT_FIT_NONE),
/* harmony export */   OBJECT_FIT_SCALE_DOWN: () => (/* reexport safe */ _cropper_utils__WEBPACK_IMPORTED_MODULE_0__.OBJECT_FIT_SCALE_DOWN),
...
/* harmony export */ });
/* harmony import */ var _cropper_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1304);
/* harmony import */ var _cropper_elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1305);
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var cropperjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1303);
/**
 * ---------------------------------------------------------------------
 *
