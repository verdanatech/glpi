...
window.diff_match_patch = (__webpack_require__(1045).diff_match_patch);
window.DIFF_DELETE = (__webpack_require__(1045).DIFF_DELETE);
window.DIFF_INSERT = (__webpack_require__(1045).DIFF_INSERT);
window.DIFF_EQUAL = (__webpack_require__(1045).DIFF_EQUAL);
