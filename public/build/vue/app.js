...
/* harmony import */ var _vue_compiler_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
...
function compileToFunction(template, options) {
  if (!(0,_vue_shared__WEBPACK_IMPORTED_MODULE_3__.isString)(template)) {
    if (template.nodeType) {
      ...
      !!(process.env.NODE_ENV !== "production") && (0,_vue_runtime_dom__WEBPACK_IMPORTED_MODULE_1__.warn)(`invalid template option: `, template);
  ...
  const opts = (0,_vue_shared__WEBPACK_IMPORTED_MODULE_3__.extend)(
    {
      ...
      onWarn: !!(process.env.NODE_ENV !== "production") ? (e) => onError(e, true) : _vue_shared__WEBPACK_IMPORTED_MODULE_3__.NOOP
    },
    options
  );
...
if (tt) {
  try {
    ...
    !!(process.env.NODE_ENV !== "production") && (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.warn)(`Error creating trusted types policy: ${e}`);
  }
}
    ...
    for (const key in next) {
      ...
      if (value != null) {
        if (!shouldPreserveTextareaResizeStyle(
          el,
          key,
          !(0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__.isString)(prev) && prev ? prev[key] : void 0,
          value
        )) {
...
function shouldPreserveTextareaResizeStyle(el, key, prev, next) {
  return el.tagName === "TEXTAREA" && (key === "width" || key === "height") && (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__.isString)(next) && prev === next;
}
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      for (let i = 0; i < children.length; i++) {
        ...
        } else if (!!(process.env.NODE_ENV !== "production") && child.type !== _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.Text) {
...
const vModelSelect = {
  ...
  created(el, { value, modifiers: { number } }, vnode) {
    ...
    addEventListener(el, "change", () => {
      ...
      const assignedValue = multiple ? (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__.isSet)(el._modelValue) ? new Set(selectedVal) : selectedVal : selectedVal[0];
      const pending = el._pendingValue = [
        multiple,
        multiple ? (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__.isArray)(assignedValue) ? selectedVal.slice() : selectedVal : assignedValue
      ];
      try {
...
function isSameSelectValue(value, assignedValue, multiple) {
  if (!multiple) return (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__.looseEqual)(value, assignedValue);
  if ((0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__.isArray)(value)) return (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__.looseEqual)(value, assignedValue);
  if ((0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__.isSet)(value)) {
...
function setSelected(el, value) {
  ...
  if (isMultiple && !isArrayValue && !(0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__.isSet)(value)) {
    !!(process.env.NODE_ENV !== "production") && (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__.warn)(
...
function watchPostEffect(effect, options) {
  return doWatch(
    effect,
    null,
    !!(process.env.NODE_ENV !== "production") ? (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.extend)({}, options, { flush: "post" }) : { flush: "post" }
  );
}
function watchSyncEffect(effect, options) {
  return doWatch(
    effect,
    null,
    !!(process.env.NODE_ENV !== "production") ? (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.extend)({}, options, { flush: "sync" }) : { flush: "sync" }
  );
}
...
function useTemplateRef(key) {
  ...
  const ret = !!(process.env.NODE_ENV !== "production") ? (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.readonly)(r) : r;
  if (!!(process.env.NODE_ENV !== "production")) {
...
Server rendered element contains more child nodes than client vdom.`
  ...
  - expected on client: ${clientText}`
      ...
      if (props) {
        if (!!(process.env.NODE_ENV !== "production") || false || forcePatch || hasDynamicProps || !optimized || patchFlag & (16 | 32)) {
          ...
          for (const key in props) {
            ...
            key[0] === "." || isCustomElement && !(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isReservedProp)(key) || dynamicProps && dynamicProps.includes(key)) {
...
function propHasMismatch(el, key, clientValue, vnode, instance) {
  ...
  if (key === "class") {
    ...
    } else if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isBooleanAttr)(key)) {
...
function normalizeHiddenValue(value) {
  if (!(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isRenderableAttrValue)(value)) {
    return false;
  }
  if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isString)(value)) {
    return value.toLowerCase() === "until-found" ? "until-found" : "";
  }
  return (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.includeBooleanAttr)(value) ? "" : false;
}
...
function renderSlot(slots, name, props, fallback, noSlotted, branchKey) {
  ...
  if (currentRenderingInstance.ce || currentRenderingInstance.parent && isAsyncWrapper(currentRenderingInstance.parent) && currentRenderingInstance.parent.ce) {
    const slotProps = branchKey != null && props.key == null ? (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.extend)({}, props, { key: branchKey }) : props;
...
const PublicInstanceProxyHandlers = {
  ...
  set({ _: instance }, key, value) {
    ...
    if (hasSetupBinding(setupState, key)) {
      ...
      return true;
    } else if (!!(process.env.NODE_ENV !== "production") && setupState.__isScriptSetup && (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasOwn)(setupState, key)) {
  ...
  const res = (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.customRef)((track, trigger) => {
    ...
    return {
      ...
      set(value) {
        ...
        if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasChanged)(value, prevSetValue) && ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasChanged)(value, emittedValue) && !(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasChanged)(emittedValue, prevEmittedValue) || // #13524: browsers differ in when they flush microtasks between
        // event listeners. If a v-model listener emits an intermediate value
        // and a following listener restores the model to its previous prop
        // value before parent updates are flushed, the parent render can be
        // deduped as having no prop change. Force a local update so DOM state
        // such as an input's value is synchronized back to the current model.
        hasVModel && prevSetValue !== _vue_shared__WEBPACK_IMPORTED_MODULE_1__.EMPTY_OBJ && !(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.hasChanged)(emittedValue, localValue))) {
          trigger();
        }
        prevSetValue = value;
...
function emit(instance, event, ...rawArgs) {
  ...
  if (modifiers) {
    ...
    if (modifiers.number) {
      args = args.map(_vue_shared__WEBPACK_IMPORTED_MODULE_1__.looseToNumber);
    }
  }
  if (!!(process.env.NODE_ENV !== "production") || false) {
    ...
    if (vnode.shapeFlag & 4) {
      ...
      result = normalizeVNode(
        render.call(
          ...
          proxyToUse,
          renderCache,
          !!(process.env.NODE_ENV !== "production") ? (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.shallowReadonly)(props) : props,
          setupState,
          data,
          ctx
        )
...
function validateProps(rawProps, props, instance) {
  ...
  for (const key in options) {
    ...
    validateProp(
      ...
      resolvedValues[key],
      opt,
      !!(process.env.NODE_ENV !== "production") ? (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.shallowReadonly)(resolvedValues) : resolvedValues,
...
function hasContentChildren(children) {
  if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isString)(children)) return children !== "";
  if ((0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(children)) return children.length > 0;
  return false;
}
...
function _createVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, isBlockNode = false) {
  ...
  if (!!(process.env.NODE_ENV !== "production") && shapeFlag & 4 && (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.isProxy)(type)) {
...
function cloneVNode(vnode, extraProps, mergeRef = false, cloneTransition = false) {
  ...
  const cloned = {
    ...
    children: !!(process.env.NODE_ENV !== "production") && patchFlag === -1 && (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isArray)(children) ? children.map(deepCloneVNode) : children,
    target: vnode.target,
...
function setupStatefulComponent(instance, isSSR) {
  ...
  if (setup) {
    ...
    const setupResult = callWithErrorHandling(
      ...
      0,
      [
        !!(process.env.NODE_ENV !== "production") ? (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.shallowReadonly)(instance.props) : instance.props,
        setupContext
      ]
    );
...
const setDevtoolsHook = !!(process.env.NODE_ENV !== "production") || true ? setDevtoolsHook$1 : 0;
const _ssrUtils = {
  ...
  (0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__.extend)(
    ...
    readonly ? {
      ...
      clear() {
        ...
        const oldTarget = !!(process.env.NODE_ENV !== "production") ? (0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__.isMap)(target) ? new Map(target) : new Set(target) : void 0;
...
function watch(source, cb, options = _vue_shared__WEBPACK_IMPORTED_MODULE_0__.EMPTY_OBJ) {
  ...
  const job = (immediateFirstRun) => {
    ...
    if (cb) {
      ...
      if (immediateFirstRun || deep || forceTrigger || (isMultiSource ? newValue.some((v, i) => (0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__.hasChanged)(v, oldValue[i])) : (0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__.hasChanged)(newValue, oldValue))) {
        if (cleanup) {
          cleanup();
        }
...
/* harmony export */ });
/* harmony import */ var _vue_compiler_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
/* harmony import */ var _vue_shared__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
/* provided dependency */ var process = __webpack_require__(6);
/**
...
const isKeyboardEvent = /* @__PURE__ */ (0,_vue_shared__WEBPACK_IMPORTED_MODULE_2__.makeMap)(`onkeyup,onkeydown,onkeypress`);
...
function compile(src, options = {}) {
  return (0,_vue_compiler_core__WEBPACK_IMPORTED_MODULE_0__.baseCompile)(
    src,
    (0,_vue_shared__WEBPACK_IMPORTED_MODULE_2__.extend)({}, parserOptions, options, {
      nodeTransforms: [
      ...
      directiveTransforms: (0,_vue_shared__WEBPACK_IMPORTED_MODULE_2__.extend)(
        {},
...
function parse(template, options = {}) {
  return (0,_vue_compiler_core__WEBPACK_IMPORTED_MODULE_0__.baseParse)(template, (0,_vue_shared__WEBPACK_IMPORTED_MODULE_2__.extend)({}, parserOptions, options));
}
...
function injectSlotKey(node, prop) {
  ...
  if (props && !(0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__.isString)(props)) {
    const [unnormalizedProps] = getUnnormalizedProps(props);
    if (unnormalizedProps && !(0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__.isString)(unnormalizedProps) && unnormalizedProps.type === 15 && hasProp(prop, unnormalizedProps)) {
      return true;
    }
  }
      ...
      if (constantType >= 2) {
        if (child.codegenNode.type === 14 && child.codegenNode.arguments.length > 0) {
          child.codegenNode.arguments.push(
            -1 + (!!(process.env.NODE_ENV !== "production") ? ` /* ${_vue_shared__WEBPACK_IMPORTED_MODULE_0__.PatchFlagNames[-1]} */` : ``)
          );
        }
        toCache.push(child);
        continue;
...
function genNodeListAsArray(nodes, context) {
  const multilines = nodes.length > 3 || !!(process.env.NODE_ENV !== "production") && nodes.some((n) => (0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__.isArray)(n) || !isText(n));
  context.push(`[`);
  ...
  let slots = createObjectExpression(
    slotsProperties.concat(
      createObjectProperty(
        ...
        createSimpleExpression(
          slotFlag + (!!(process.env.NODE_ENV !== "production") ? ` /* ${_vue_shared__WEBPACK_IMPORTED_MODULE_0__.slotFlagsText[slotFlag]} */` : ``),
          false
        )
      )
    ),
...
function buildProps(node, context, props = node.props, isComponent, isDynamicComponent, ssr = false) {
  ...
  for (let i = 0; i < props.length; i++) {
    ...
    if (prop.type === 6) {
      ...
      if (isVOn && hasChildren && arg && isStaticExp(arg) && (0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__.camelize)(arg.content) === "vue:beforeUpdate") {
        shouldUseBlock = true;
...
/* harmony export */   nodeOps: () => (/* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_1__.nodeOps),
...
/* harmony export */   patchProp: () => (/* reexport safe */ _vue_runtime_dom__WEBPACK_IMPORTED_MODULE_1__.patchProp),
...
const map = {
	"./CustomObject/FieldPreview/Field.vue": [
		11,
		[
			0
		]
	],
	"./CustomObject/FieldPreview/FieldDisplay.vue": [
		28,
		[
			0,
			2,
	...
	"./CustomObject/FieldPreview/Sidebar.vue": [
		33,
		[
			0,
			2
	...
	"./Debug/Widget/ClientPerformance.vue": [
		52,
		[
			4
		]
	],
	"./Debug/Widget/Globals.vue": [
		57,
		[
			5
		]
	],
	"./Debug/Widget/HTTPRequests.vue": [
		65,
		[
			10,
			6
	...
	"./Debug/Widget/Profiler.vue": [
		78,
		[
			7
		]
	],
	"./Debug/Widget/ProfilerTable.vue": [
		83,
		[
			8
		]
	],
	"./Debug/Widget/RequestSummary.vue": [
		91,
		[
			9
		]
	],
	"./Debug/Widget/RequestTimeline.vue": [
		70,
		[
			10
		]
	],
	"./Debug/Widget/SQLRequests.vue": [
		96,
		[
			11
		]
	],
	"./Debug/Widget/SearchOptions.vue": [
		104,
		[
			12
		]
	],
	"./Debug/Widget/ServerPerformance.vue": [
		112,
		[
			13
		]
	],
	"./Debug/Widget/ThemeSwitcher.vue": [
		117,
		[
			14
		]
	],
	"./Debug/WidgetButton.vue": [
		122,
		[
			15
		]
	],
	"./EntitySelector/EntitySelector.vue": [
		127,
		[
			16
		]
	],
	"./FullCalendar/BaseFullCalendar.vue": [
		136,
		[
			33,
			17
	...
	"./FuzzySearch/Modal.vue": [
		233,
		[
			18
		]
	],
	"./Kanban/AddItemForm.vue": [
		238,
		[
			19
		]
	...
	"./Planning/PlanningFiltersList.vue": [
		294,
		[
			35,
			26
	...
	"./Planning/PlanningFiltersPanel.vue": [
		299,
		[
			35,
			36,
	...
	"./Planning/PlanningScheduler.vue": [
		307,
		[
			33,
			37,
	...
	"./Reservations/ReservationEvent.vue": [
		367,
		[
			30
		]
	],
	"./Reservations/ReservationScheduler.vue": [
		375,
		[
			33,
			37,
...
/******/ 	__webpack_require__.u = (chunkId) => (({"0":"/vue-sfc/CustomObject-FieldPreview-Field-vue","1":"/vue-sfc/CustomObject-FieldPreview-FieldDisplay-vue","2":"/vue-sfc/CustomObject-FieldPreview-Sidebar-vue","3":"/vue-sfc/Debug-Toolbar-vue","4":"/vue-sfc/Debug-Widget-ClientPerformance-vue","5":"/vue-sfc/Debug-Widget-Globals-vue","6":"/vue-sfc/Debug-Widget-HTTPRequests-vue","7":"/vue-sfc/Debug-Widget-Profiler-vue","8":"/vue-sfc/Debug-Widget-ProfilerTable-vue","9":"/vue-sfc/Debug-Widget-RequestSummary-vue","10":"/vue-sfc/Debug-Widget-RequestTimeline-vue","11":"/vue-sfc/Debug-Widget-SQLRequests-vue","12":"/vue-sfc/Debug-Widget-SearchOptions-vue","13":"/vue-sfc/Debug-Widget-ServerPerformance-vue","14":"/vue-sfc/Debug-Widget-ThemeSwitcher-vue","15":"/vue-sfc/Debug-WidgetButton-vue","16":"/vue-sfc/EntitySelector-EntitySelector-vue","17":"/vue-sfc/FullCalendar-BaseFullCalendar-vue","18":"/vue-sfc/FuzzySearch-Modal-vue","19":"/vue-sfc/Kanban-AddItemForm-vue","20":"/vue-sfc/Kanban-Card-vue","21":"/vue-sfc/Kanban-Column-vue","22":"/vue-sfc/Kanban-Kanban-vue","23":"/vue-sfc/Kanban-KanbanApp-vue","24":"/vue-sfc/Planning-PlanningEvent-vue","25":"/vue-sfc/Planning-PlanningFilter-vue","26":"/vue-sfc/Planning-PlanningFiltersList-vue","27":"/vue-sfc/Planning-PlanningFiltersPanel-vue","28":"/vue-sfc/Planning-PlanningScheduler-vue","29":"/vue-sfc/Planning-PlanningView-vue","30":"/vue-sfc/Reservations-ReservationEvent-vue","31":"/vue-sfc/Reservations-ReservationScheduler-vue"}[chunkId] || chunkId) + "-" + {"0":"3c31126854de7bb77a02","1":"6a8496983061eddfd597","2":"aa078b0176f28e515659","3":"e71951a4966cebf68d91","4":"ce7a94c07b6b32e27593","5":"7217deace43bcb1a3b76","6":"fb3ebc67125ad57b03de","7":"b697dbe5e2262149265d","8":"44d2eb09bf68319ba037","9":"8e50fe8c3482d46fe7f9","10":"61936d0f057ba8f38f4f","11":"1868c2c05712d572df03","12":"e43c39cae96b6fd8fe01","13":"be578b28177c915f4e19","14":"c91971f2360e1250e4a7","15":"cf4ca5ee978a94e67a0c","16":"e6e122fa949472d2cff5","17":"3f6c970a62c1ba1954da","18":"5792cbbd151c22e8a6d0","19":"020ea2eab04ff3d59bdf","20":"6d55269d668c82b83605","21":"ba418b33187f0ce5e8d5","22":"24d9c28af75f9def25c4","23":"e8ff109146ebb15ec376","24":"e20a1dd1b7a7eafc6015","25":"9be770ad1b0528824127","26":"1601ce661f0ba1c401ac","27":"e969ea521a8e4be2cd14","28":"3748f43b177b3aa4ad9c","29":"40191eadf0007cd593d8","30":"9a027f7f85b16bf16e69","31":"2ac9a70802dcdd7da642","33":"c4e6aaeb5b798a95c04d","34":"f156d13e5d49ace07460","35":"0f939c47a394629ddceb","36":"c10eaddff194c2775f6f","37":"0e198bc610a08de54aab","38":"396a343142a301d4504e"}[chunkId] + ".js");
/******/ 	
...
/******/ 	(() => {
/******/ 		const inProgress = {};
/******/ 		const dataWebpackPrefix = "@glpi/glpi:";
...
/******/ 	__webpack_require__.p = "/build/vue";
/******/ 	
...
/******/ 		}
/******/ 		
/******/ 		const chunkLoadingGlobal = self["webpackChunk_glpi_glpi"] = self["webpackChunk_glpi_glpi"] || [];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
window.Vue = {
    createApp: (...args) => {
        ...
        const app = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.createApp)(...args);
    ...
    defineAsyncComponent: vue__WEBPACK_IMPORTED_MODULE_1__.defineAsyncComponent,
...
const component_context = __webpack_require__(10);

/* global __webpack_public_path__ */
// eslint-disable-next-line no-global-assign
__webpack_require__.p = `${CFG_GLPI.root_doc + __webpack_require__.p}/`;
...
component_context.keys().forEach((f) => {
    ...
    components[component_name] = {
        component: vue__WEBPACK_IMPORTED_MODULE_1__.defineAsyncComponent(() => component_context(f)),
    };
});
...
window._vue = vue__WEBPACK_IMPORTED_MODULE_1__;
